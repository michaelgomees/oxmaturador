...
-- 4. Trigger para aplicar updated_at automaticamente
...
-- 7. Remover campo senha_hash da função get_user_for_login por segurança
...
-- 9. Adicionar constraint único para email 
